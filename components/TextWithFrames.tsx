  ...
  return (
    <div>
      ...
      <div className="m-auto max-w-2xl border p-4 ">
          ...
          return (
<p key={lineIndex} style={{ margin: 0, display: "flex", flexWrap: "wrap" }}>
{words.map((word, wordIndex) => {
                const globalIndex = words
                  .slice(0, wordIndex)
                  .join("").length + lineIndex * 1000; // Identifiant unique
                ...
                return (
                  <span
                    ...
                    style={{
                      ...
                      color: selectedWords.has(globalIndex)
                        ? "white"
                        : "black",
