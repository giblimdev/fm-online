      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6 font-serif">
        ...
        <div className="text-center mb-8 pb-4">
          <h1 className="text-2xl font-bold title-font text-amber-900">
            Cérémonial d'ouverture d'un Prieuré de l'Ordre
          </h1>
        </div>

        <div className="space-y-6 leading-relaxed text-sm">
          {/* Première instruction */}
          <p className=" com ">Les Chevaliers sont assis.</p>

          {/* Dialogue cérémoniel */}

          <p className="">Mar. — Chevaliers, mes Frères - DE — BOUT.</p>
          ...
          <div className="bg-amber-50 p-4 rounded-lg ">
            ...
            <div className="bg-white p-4 rounded border border-amber-200 max-w-md mx-auto">
              <div className="space-y-2 text-center">
                ...
                <div className="font-bold">Chanc.</div>
                <div className="font-bold ">Bailli</div>
                <div className="font-bold ">Amiral</div>
                <div className="font-bold ">Chap.</div>
                <div className="font-bold ">1er Lt.</div>
          ...
          <p className="com">
            La procession remontant par le nord, fait halte et les deux colonnes
            se font face lorsque le Mar. Adj. arrive à mi-chemin entre les deux
            tables (voir p. 80).
            <br />
            ...
            c'est-à-dire par ordre hiérarchique <b>décroissant</b>.
            <br />
            Les officiers de la table octogonale gagnent leur placeaprès le
            passage du Chap., dans l'ordre hiérarchique (Mar., Hosp., Amir.,
            Cons. Bailli, Turc., Chan. et Très.) décroissant, alternativement au
            sud et au nord de la table.
          </p>
          <div className="">
            <p>Mar. —Chevaliers, mes Frères — PRENEZ — PLACE.</p>
            <p>
              Ém. P. —Digne Capitaine-Général, quel est le premier et le plus
              essentiel devoir d'un Chevalier de Malte?
            </p>
            <p>
              Cap.-Gal —De s'assurer que nos Frères d'armes sont bien protégés
              des adversaires de l'Évangile de Notre Seigneur, le S. de
              l'humanité pécheresse.
            </p>
            <p>
              Ém. P. —Digne Lieutenant-Général, faites votre devoir et
              assurez-vous que le Prieuré est bien gardé.
            </p>
            <p>
              Lt.-Gal{" "}
              <span className="com">
                se lève, dégaine son épée, va à la porte et y frappe du pommeau
              </span>{" "}
              - O --- O - O - O - O - O - O - O - O - O - O - O - O -
            </p>
            <p>
              Gard.répond — - O --- O - O - O - O - O - O - O - O - O - O - O -
              O -
            </p>
            <p className="com">
              Lt.-Galretourne à sa place, vient au «PRÉSENTEZ» et fait son
              rapport (sans faire aucun autre signe).
            </p>
            <p>
              Lt.-Gal —Éminent Prieur, tout est bien gardé.il rengaine son épée
              et s'assied.
            </p>
            <p>
              Ém. P. —Digne Capitaine-Général, quel est notre second devoir?
            </p>
            <p>
              Cap.-Gal —De veiller à ce que tous les gens de guerre présents
              prouvent qu'ils sont de vrais compagnons de notre Ordre.
            </p>
            <p>Ém. P. —Veuillez vous en assurer.</p>{" "}
            <p>Mar. —Chevaliers, mes Frères — DE — BOUT ! </p>
            <p className="com">
              Tous se lèvent et se tiennent au «PORTEZ» y compris les officiers
              des tables. Le nord, le second au sud. Chaque Général reçoit
              d'abord l'A. de N. ou du r. au Chev, qu'il éprouve, (a) qu'il est
              la Mots «R. d. R.» et le Chev, répond par les mots «S. d. S.». Les
            ...
            <p className="italic">
              Les gens de guerre présents ont prouvé qu'ils étaient de vrais
            ...
            <p className="italic">
              Éminent Prieur, les gens de guerre présents ont prouvé qu'ils
              étaient de vrais compagnons de notre Ordre.
            </p>
            <p className="font-bold text-amber-900 mb-2">Ém. P. —</p>
            <p className="italic">
              Mes Frères, implorons la bénédiction divine sur cette assemblée.
            </p>
            {/* Prière */}
            <div className="bg-amber-50 p-4 rounded-lg border-l-4 border-amber-400">
              ...
              <p className="mb-3">
                ...
                tables posant l'extrémité de la lame de leur épée sur la table.
              </p>
            ...
            <div className="bg-amber-50 p-4 rounded-lg border-l-4 border-amber-400">
              <div className="bg-amber-100 p-4 rounded-lg border border-amber-300">
                <p className="font-bold text-amber-900 mb-2">Ém. P. —</p>
                <p className="italic">
                  Au nom de la Très Sainte Trinité, je déclare dûment ouvert et
                  constitué ce Prieuré de Chevaliers de Malte.
                </p>
              </div>
              <p className="mt-3">
                Trente-trois coups sont frappés du pommeau de l'épée, également
                espacés.
              </p>
              <p>
