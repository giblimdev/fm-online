...
export default function Page() {
  return (
    <div>
      ...
      <p>
        Les cinq Chev. désignés se lèvent, dégainent et prennent poste chacun
        devant sa bannière, face au nord. Si la salle est trop petite, ils se
        tiennent à côté de leur bannière, face au sud. (cf. p. 80)Les bannières
        sont alignées d'ouest en est, le long du trajet qu'empruntera le Cand.{" "}
        <br />
        Le Mar. épée au « PORTEZ », et le Cand. viennent à la porte de la salle
        capitulaire.
      </p>
      <p>
        Gard.
      ...
      <p>
        Ém. P. — Voyez qui frappe ainsi. C.A.P. ouvre la porte — Qui va là? Mar.
        — Un/De digne(s) Chevalier(s), Soldat(s) de la Croix, demande(nt) à être
        admis. C.A.P. — À quel Ordre appartient(en)t-il(s)? Mar. — À l'Ordre des
        Chevaliers du Temple. C.A.P. — A/ ont-t-il(s) les qualifications
        requises? Mar. — Il(s) les a / ont. C.A.P. — Faites halte pendant que je
        fais mon rapport à l'Éminent Prieur et aux Chevaliers réunis en Conseil.
        Le C.A.P. ferme la porte et fait son rapport. C.A.P. — Éminent Prieur,
        un/de digne(s) Chevalier(s), Soldat(s) de la Croix, demande(nt) d'être
        admis. Ém. P. — Admettez-le(s). C.A.P. ouvre la porte — J'ai reçu
        l'ordre de vous admettre. Donnez-moi les M. de P.{" "}
      </p>
      <p>
        Cand. — S. s. c., P. (q) À chaque bannière, le Cand. recevra une
        sommation de la façon suivante : a) Si le Garde se tient devant sa
        bannière, face au nord, (cf. Nota au bas p. 18) il se tournera vers
        l'ouest à l'approche du Cand. Il pointera son épée vers la poitrine du
        Cand. et fera la sommation. Lorsqu'il aura reçu la réponse, le Garde se
        remettra au « PORTEZ », se retournera par la droite vers le nord,
        déploiera la bannière avec la pointe de son épée, de façon à l'exposer à
        la vue du Cand. et lui donnera le nom de la bannière et le Mot. Puis il
        repliera la bannière et se remettra au « PORTEZ ». <br />
        b) Si le Garde se tient à côté de la bannière, face au sud, il fera deux
        pas en avant vers le sud à l'approche du Cand., se tournera par la
        droite vers l'ouest, pointera son épée vers la poitrine du Cand. et fera
        sa sommation. <br />
        Quand il recevra la réponse, le Garde se remettra au « PORTEZ », se
        tournera par la droite vers le nord, déploiera la bannière avec la
        pointe de son épée, afin de l'exposer à la vue du Cand., et lui donnera
        le nom de la bannière et le Mot. <br />
        Puis le Garde repliera la bannière, se remettra au « PORTEZ », fera deux
      ...
      <p>
        ...
        convenablement placé pour que le Garde puisse faire effectivement sa
      ...
      <p>(p) Cand. — M. </p>
      <p>
        G.B.P. — Voici la bannière de Palestine. (h) Le mot est N., (ou V.){" "}
      </p>
      <p>G.B.Ch. sommation — Donnez-moi le mot de la bannière de Palestine.</p>
      <p>(h) Cand. — N. </p>
      <p>
        G.B.Ch. — Voici la bannière de Chypre. (i) Le mot est V. G.B.R.
        sommation — Donnez-moi le mot de la bannière de Chypre.
      </p>
      <p>
        Cand. — V. (j) G.B.R. — Voici la bannière de Rhodes. Le mot est M.
        G.B.C. sommation — Donnez-moi le mot de la bannière de Rhodes. (j) Cand.
        — M. G.B.C. — Voici la bannière de Candie. (k) Le mot est R. G.B.M.
        sommation — Donnez-moi le mot de la bannière de Candie. (k) Cand. — R.
        G.B.M. — Voici la bannière de Malte. (l) Le mot est A. Une fois passée
        la bannière de Malte, le Mar. conduit le Cand. à l'extrémité est de la
        table octogonale, face à l'est. Par la suite il lui soufflera les
        réponses. Les Gardes prennent leur poste chacun à côté et à l'est de sa
        bannière et restent debout au « REPOS ». Ém. P. — Frère Chevalier,
        souhaitez-vous vraiment rejoindre notre Ordre et combattre sous notre
        sainte bannière tous les adversaires de l'Évangile de Notre Seigneur et
        Sauveur? Cand. — Je le souhaite vraiment. Ém. P. — Quelle preuve en
        apportez-vous ? Cand. — guidé par le Mar. J'ai ceci. (il montre sa Croix
        de Chev. du Temple.) Ém. P. — Donnez-moi le mot de la bannière de Malte.
        Cand. — A.{" "}
      </p>
      <p>
        (l) Ém. P. — Êtes-vous prêt à vous conformer aux règles et règlements de
        notre Ordre et à strictement les respecter ?{" "}
      </p>
      <p>
        Cand. — Je le suis. Ém. P. — Êtes-vous prêt à en prendre l'engagement?
        Cand. — Je le suis. Ém. P. — Dans ce cas, avancez-vous jusqu'à cette
        table. Mettez-vous à genoux et contractez les vœux des Chevaliers
        maçonniques de Malte. Mar. — Chevaliers, mes Frères - DE - BOUT.{" "}
      </p>
      <p>
        Le Mar. conduit le Cand., par le sud, jusqu'à l'agenouilloir installé à
        l'ouest de la table pentagonale. Il lui demande de dégainer et de placer
        son épée en travers de la Bible ouverte, la poignée vers le sud, de
        s'agenouiller sur les deux genoux, et de placer la main droite sur épée
        et la Bible.{" "}
      </p>
      <p>
      ...
      <p>
        ...
        vont m'être confiés; et de me conformer en tout point aux règles et
        règlements de cet Ordre Ancien et Maçonnique tels qu'ils figurent dans
        les statuts du Grand Prieuré des Ordres Unis pour la France, sous la
        moindre des peines d'avoir m. c. f. d. s. a. m. Ainsi, que Dieu me soit
        en aide.
      </p>
      <p>
        (r) Ém. P. — Veuillez sceller ces vœux de vos lèvres par trois fois sur
        le Saint Évangile.
      </p>
      <p>
        Le Cand. s'exécute. <br />
        Le Mar. dit au Cand. de se relever, de prendre son épée et de la
        rengainer. Le Mar. Adj. s'avance, emporte le prie-Dieu et va le placer à
        mi-chemin entre la table pentagonale et l'est, face à l'ouest. Le Mar.
      ...
      <p>
        Chap. lit Mat. 5, 1-12 — Quand Jésus vit toute la foule qui le suivait,
        il gravit la montagne, Il s'assit, et ses disciples s'approchèrent.
        Alors, ouvrant la bouche, Il se mit à les instruire. Il disait : «
        Heureux les pauvres de cœur : le Royaume des cieux est à eux ! « Heureux
        les doux : ils obtiendront la terre promise! « Heureux ceux qui pleurent
        : ils seront consolés! « Heureux ceux qui ont faim et soif de justice :
        ils seront rassasiés! « Heureux les miséricordieux : ils obtiendront
        miséricorde! « Heureux les cœurs purs : ils verront Dieu! « Heureux les
        artisans de la paix : ils seront appelés fils de Dieu! « Heureux ceux
        qui sont persécutés pour la justice : le Royaume des Cieux est à eux ! »{" "}
        <br />« Heureux serez-vous si l'on vous insulte, si l'on dit faussement
        toute sorte de mal contre vous, à cause de moi. <br />« Réjouissez-vous,
      ...
      <p>
        ...
        maçonnique de l'Hôpital de Saint-Jean de Jérusalem et de Palestine,
        Rhodes et Malte. L'Ém. P. pose son épée une fois sur l'épaule droite du
        Cand. en disant : <br />
        — Sois Preux, Hardi et Juste <br />
        L'Ém. P. fait passer son épée dans sa main gauche. Puis il donne la
        collée au Cand., c'est-à-dire un coup viril de la paume droite sur le
        bas de la nuque. Il prend ensuite la main droite du Cand. et le relève
        avec ces mots : <br />
      ...
      <p>
        Ém. P. — Je vous décore maintenant du bijou de notre Ordre. C'est le
        symbole bien connu des Chevaliers de Saint-Jean et le signe de la
        Rédemption. Sa blancheur vous rappellera à jamais la pureté de vie
        exigée des soldats du Christ et de Ses serviteurs. Ses quatre branches
        symbolisent les vertus cardinales : la Force d'âme, la Prudence, la
        Tempérance et la Justice que vous avez appris à mieux connaître dans les
        grades symboliques de la Franc-Maçonnerie. Ses huit pointes et son
        centre représentent les Béatitudes, dont ces vertus sont la source, et
        qui furent enseignées par notre Sauveur dans le Sermon sur la Montagne.
        (si le Sermon sur la Montagne a été lu (p. 50) il ajoutera : que vous
      ...
      <p>
        Ém. P. — Je vous revêts de ce manteau noir portant la croix blanche
        octogone de l'Ordre. C'est le vêtement de ceux qui se dévouent à la
        défense de la Foi chrétienne et au service du pauvre et du malheureux.
        L'Ém. P. noue les cordons du manteau. Mar. — Chevaliers, mes Frères,
        PRENEZ - PLACE.{" "}
      </p>
      <p>
        Le Mar. invite le Cand. à dégainer son épée, puis il présente son épée à
        l'Ém. P. qui la prend.{" "}
      </p>
      <p>
        Ém. P. — Je vais vous confier l'Attouchement, les Mots, le G. N. et les
        Signes de l'Ordre. L'Attouchement de N. ou du r. ou Gage se donne,
        (a)(c) l'épée dans la m. d., au « PORTEZ ». Entrelaçant les d. des m. g.
        on fait un mouvement d'a. en a. p. t. f. avec les m. j., comme p. r. (b)
        Les M. sont « R. des R. » et la réponse « S. des S. » (a) Pour éprouver
        un Chevalier de l'Ordre, on lui demande de donner l'Attouchement du r.
        ou Gage. (b) L'attouchement engagé, l'interrogateur dit alors « R. des
        R. », et l'interrogé répond « S. des S. » Chevalier mon Frère, rengainez
        votre épée. L'Ém. P. rend l'épée au Mar. (d) Le G. N. est J. E. (e) Le
        Signe de l'Ordre ou signe pénal du grade se fait ainsi, de la m. d., p.
        f. p., t. t., faites descendre votre (e) p. le l. d. v., du s. d. c. à
        a. m. Ce Signe doit toujours être fait avec la main seule, jamais avec
        l'épée. (f) <br />
        Le S. d'A. se fait en p. l'i. d. l. m. d. v. l. C.{" "}
      </p>
      <p>
        L'Ém. P. regagne sa place. Le Mar. place le Cand. au sud de la table
        pentagonale. Le Mar. Adj. prend alors en charge le Cand. Le Mar. regagne
        sa place, à la table octogonale, y dépose son épée et s'assied. Le Mar.
        Adj. ordonne aux Gardes de se tenir au « PORTEZ » près de leurs
        bannières. Mar. Adj. — Chevaliers Gardes des bannières — À VOS — POSTES.{" "}
      </p>
      <p className="com">
        Quand l'Ém. P. fera allusion à une bannière, le Garde concerné inclinera
        ou élèvera sa bannière avec la main gauche (comme précisé en rubrique
        dans le texte), de telle façon que le Cand. puisse la voir. À la fin de
        chaque passage relatif, le Garde redressera ou abaissera sa bannière. Si
        les bannières sont pourvues au coin supérieur libre d'un « godet » ou «
