  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          (c) main droite au Portez, Entrelacant les doigts des mains gauches,
          on fait un mouvement d'avant en arrière, par trois fois avec les mains
          jointes, comme pour ramer.
        </li>{" "}
        <li>(d) la Grand Nom est Jésus Emmanuel</li>{" "}
        <li>
          (e) de la main droite, poing fermé, pouce tendu, faire descendre votre
          pouce le long du visage, du sommet du front au menton.
        </li>{" "}
        <li>
          (f) le Signe d'Ascension se fait en pointant l'index de la main droite
          vers le Ciel.
        </li>{" "}
        <li>
          (g) de la Nativité (ou Naissance), de la Vie, de la Mort, de la
          Résurrection et de l'Ascension du Christ, le Sauveur de l'humanité.
        </li>{" "}
        <li>(h) Nativité (ou Naissance)</li> <li>(i) Vie</li> <li>(j) Mort</li>{" "}
        <li>(k) Résurrection</li> <li>(l) Ascension</li>{" "}
        <li>(m) Mot du Croisé (Golgotha)</li>{" "}
        <li>
          (n) en secouant la main droite comme si on voulait faire lâcher prise
          à une vipère.
        </li>{" "}
        <li>
          (o) en s'accrochant mutuellement le petit doigt de la main droite et
          retournant les mains, puis en se pinçant à tour de rôle la peau du
          dessus de la main du vis-à-vis entre le pouce et l'index.
        </li>{" "}
        <li>(p) la Passe de Méditerranée est Melita</li>{" "}
        <li>
      ...
      <p>
        ...
        international de reconnaissance.
      </p>
