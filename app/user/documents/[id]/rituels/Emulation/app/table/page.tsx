//@/app/rituels/Emulation/app/table
...
function page() {
  return (
    <div>
      ...
      <p>
        Les tenues sont ordinairement suivies d'une agape obligatoire durant
        laquelle les FF. peuvent converser librement entre eux, sous les
        réserves d'usage, et au cours de laquelle sont portés des Toasts, dans
        un ordre précis, constituant le protocole à table. La meilleure
        disposition de la table en en « U ». Les branches verticales du « U »
        figurent les cc. du N et du M. et la branche horizontale l'or. Les
        places de l'Or. sont réservées aux PP.MM. et GG.OO. Provinciaux (à la g.
        du VM.) ou nationaux (à la d. du VM.) Les SS. Se place au bout de de
        leur C. respective, face aux VM., dont la place est au milieu de l'Or.
        Avec le PMI. à sa g., tous les autres FF. se placent à table comme ils
        le souhaitent, y compris les Ap. et les Cp. Lorsque la cérémonie a donné
        lieu à un Initiation, le nouvel initié, est placé exceptionnellement à
        la droite immédiate du VM. Pour les autres cérémonies (Passage,
        Élévation) le Cand. prend place sur les cc.
      </p>

      <p>
        Avant le début des Toasts protocolaires, (et après les graces) la
        tradition permet de « prendre le vin avec... ». Cela doit être fait avec
        décorum et retenue. L'usage veut alors que l'on ne puisse inviter à «
        prendre le vin », un F. d'un grade ou fonction supérieur. Nul ne peut
        donc solliciter le VM., à ce titre, sauf le GM ou le GMP Il est d'usage
        que le VM souhaite entendre « quelques mots de réponse » aux toasts qui
      ...
      <p>
        ...
        autorisation du VM. Lorsque les coups sont donnés les FF. doivent faire
        silence et être prêts à se lever à l'invitation du VM. ou du PMI.
      </p>
      ...
      <p>
        <b>PMI </b>: - O - <span className="com">et se lève</span>
      </p>
      <p>
        <b>1er S </b>: - O - <span className="com">et se lève</span>
      </p>
      <p>
        <b>2d S </b>: - O - <span className="com">et se lève</span>
      </p>
      <p className="com">(Les FF. font silence)</p>
      <p>
        <b>PMI </b>: FF. SS., tout est-il chargé sur vos colonnes respectives ?
      </p>
      <p className="com">
        Les SS s'assurent que tout est bien chargé, sinon ils font le
        nécessaire.
        <br />
        Puis ils répondent :
      </p>
      <p>
        <b>1er S </b>: Tout est chargé à l'Occ.
      </p>
      <p>
        <b>2d S </b>: Tout est chargé au M.
      </p>
      ...
      <p>
        <b>Tous </b>: « Aux Souverains et Chefs d’États qui protègent le FM. »
        Puis se rassoient.
      </p>
      <h3>3/ Au T.R.G.M.</h3>
      <p>
      ...
      <p>
        ...
        Si T.R.G.M. est présent, il peut, s'il le souhaite, prononcer quelques
        mots de réponse au Toast en son honneur.
      </p>
      <h3>4/ A la GLNF</h3>
      <p>
        <b>PMI </b>: - O -
      ...
      <p>
        ...
        <span className="com">Puis se rassoient.</span> <br />
        Le VM, si cela a été convenue préalablement, peut demander une réponse à
        un Off. de G.L.
      </p>
      ...
      <p>
        <b>Tous </b>: «au TRGM. Pro. et à la GLP de …....»
      </p>
      <p>
        Puis se rassoient. Le VM., si cela a été convenue préalablement, peut
        demander une réponse à un Off. de GLP. Ceci se fait alors dans les
      ...
      <p>
        <b>PMI </b>: - OO - <span className="com">en restant assis</span>
      </p>
      <p>
        Le T se lève et vient avec son verre se placer derrière le VM. Il place
