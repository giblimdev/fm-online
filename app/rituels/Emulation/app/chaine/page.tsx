...
function page() {
  return (
    <div>
      ...
      <p>
        Mes FF. et toi particulièrement toi, notre F ; … nouvellement initié
        parmi les M. La FM étant un système particulier de morale enseigné sous
        ...
        lorsqu’il plaira au GADL’U d’appeler un des F. à la Grande Loge d’en
        haut, la chaîne ne sera pas rompue mais seulement affaiblie pour un
        temps, jusqu’à ce qu’un nouveau maillon soit mis en place. <br />
        De nombreux et valeureux F. bien aimés ont formé les maillons de cette
