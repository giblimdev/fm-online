...
export async function GET(
  ...
  try {
    ...
    console.error(`[API GET] Erreur récupération texte id=${id}:`, error);
...
export async function PUT(
  ...
  try {
    ...
    console.error(`[API PUT] Erreur mise à jour texte id=${id}:`, error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error(`[API DELETE] Erreur suppression texte id=${id}:`, error);
